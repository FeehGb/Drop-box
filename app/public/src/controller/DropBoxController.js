class DropBoxController {
    ...
    connectFireBase() {
        // Initialize Firebase
        var config = {
            apiKey: "AIzaSyBKoIRxTubbMQm1GTi0HiO0Dpspm9bALlg",
            authDomain: "dropbox-clone-26052.firebaseapp.com",
            databaseURL: "https://dropbox-clone-26052.firebaseio.com",
            projectId: "dropbox-clone-26052",
            storageBucket: "dropbox-clone-26052.appspot.com",
            messagingSenderId: "3503990655"
        };
    ...
    readFiles() {
        ...
        this.getFireBaseRef(this.lastFolder).on('value', snapshot => {
